...
Do not reopen <CONTACT_7_NAME> on `ikhalid@`, Arabic-only names, or `wf04-v5`
...
| **False reconciliation** | Ledger vs Apollo remaining only *looked* matched. The extra +1 on `73fc2831` was offset by a second off-by-one of the opposite sign. Two errors of one cancelled. | A matching pair of totals was quoted as proof. Read-back of Profile GET vs the ledger rows did not. Do not invent a second UUID. Do not edit `73fc2831`. |
...
| interactions | 13 |
| extraction_runs | 22 |
| entity_candidates | 3 (1 accepted <CONTACT_7_NAME> merge, **2 pending**) |
...
|---|---|---|---|---|---|---|
| 00 | `<WF00_ID>` | LNI WF-00 - Central error handler | true | `<WF00_PUBLISHED>` | same | true |
| 00b | `<WF00B_ID>` | LNI WF-00b - Credential and connectivity probe | false | `<WF00B_SAVED>` | null | false |
| 01 | `<WF01_ID>` | LNI WF-01 - Telegram ingest router | true | `e3f817e2-9989-4486-8c7d-fe2ebb0d1b8a` | same | true |
| 02 | `<WF02_ID>` | LNI WF-02 - Capture lifecycle | true | `ddb4d858-b100-4a13-a567-b8528cb892c8` | same | true |
| 03 | `<WF03_ID>` | LNI WF-03 - Asset processors | true | `<WF03_PUBLISHED>` | same | true |
| 04 | `<WF04_ID>` | LNI WF-04 - Structured extraction | true | `<WF04_PUBLISHED>` | same | true |
| 05 | `<WF05_ID>` | LNI WF-05 - Entity resolution | true | `181a4c32-1406-440d-9f1c-b927d6cf80b1` | same | true |
| 06 | `<WF06_ID>` | LNI WF-06 - Enrichment | **true** | `<WF06_ROLLBACK>` | same | true |
| 07 | `<WF07_ID>` | LNI WF-07 - Digests | true | `<WF07_PUBLISHED_9_14>` | same | true |
| 08 | `<WF08_ID>` | LNI WF-08 - Query (/ask) | true | `<WF08_PUBLISHED>` | same | true |
| 09 | `<WF09_ID>` | LNI WF-09 - Watchdog | true | `4747cd4f-ea03-451b-bf76-f09e5a6544db` | same | true |
