...
Apollo credit `001dd474` on <CONTACT_18_NAME> (`d8b051cb`). Not WF-02.
...
| Person | `d8b051cb-9325-4a43-9c6c-c0cbf286b404` <CONTACT_18_NAME> |
...
`2026-08-29 05:45:01+00`, `entity_id` = <CONTACT_18_NAME>.

Do not treat #120 as a clean follow-up. Do not replay it
as a proof. Draft `6f3c13b3` stays as evidence. Do not
delete it from a packet. Do not delete <CONTACT_18_NAME> `d8b051cb`.
...
- Phase 9: Packet 9.6 PUT is live (`<WF01_PUBLISHED>`). Owner
