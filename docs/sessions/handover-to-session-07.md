...
| interactions | 13 |
| extraction_runs | 22 |
| entity_candidates | 3 (1 accepted <CONTACT_7_NAME> merge, 2 pending person) |
...
- **Supabase hardening.** Disable public signup, delete unconfirmed
  auth user `<STRAY_AUTH_USER_ID>`, re-enable Confirm email. Owner.
...
- **BotFather `/setcommands`** on `@<BOT_USERNAME>` (zero-risk; does
