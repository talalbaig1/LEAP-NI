...
|---|---|---|---|
| 00 | `<WF00_ID>` | true | `6eb149ae-296d-4e1a-833a-d0c5ab01c085` |
| 00b | `<WF00B_ID>` | false | `<WF00B_SAVED>` |
| 01 | `<WF01_ID>` | true | `a5789a7e-d07e-4462-b309-ff225061209e` |
| 02 | `<WF02_ID>` | true | `ddb4d858-b100-4a13-a567-b8528cb892c8` |
| 03 | `<WF03_ID>` | true | `<WF03_PUBLISHED>` |
| 04 | `<WF04_ID>` | true | `<WF04_PUBLISHED>` |
| 05 | `<WF05_ID>` | true | `b4be6046-6c49-42d6-94d1-9832dfa3275d` |
| 07 | `<WF07_ID>` | true | `<WF07_PUBLISHED_9_14>` |
| 08 | `<WF08_ID>` | true | `<WF08_PUBLISHED>` |
| 09 | `<WF09_ID>` | true | `4747cd4f-ea03-451b-bf76-f09e5a6544db` |
...
- Locked decisions: pre-event scope; <CONTACT_7_NAME> on the `…lid@` row (OCR split vs `…ld@`); Arabic-only
