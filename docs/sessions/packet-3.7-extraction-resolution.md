...
|---|---|---|---|
| WF-04 | `<WF04_ID>` | `7ea4404b-4ea4-4132-b7e4-91b85c7f1b87` | Leap-NI postgres `<PG_CRED_ID>`, OpenAI `<OPENAI_CRED_ID>` |
| WF-05 | `<WF05_ID>` | `b4be6046-6c49-42d6-94d1-9832dfa3275d` | Leap-NI postgres `<PG_CRED_ID>` |
...
Huawei legal with domain `huawei.com`. Person `<CONTACT_9_NAME>` /
`نائب المدير` / `<CONTACT_9_EMAIL>` linked to all three Huawei
...
never decode the pattern. versionId `<WF03_PUBLISHED>`.
...
`name_original_script` `<CONTACT_52_NAME>`. Executions: WF-01 `255194`,
