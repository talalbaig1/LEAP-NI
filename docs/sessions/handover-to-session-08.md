...
- **WF-10 stays INACTIVE.** id `<WF10_ID>`. Never
  `POST /activate`.
- **WF-01 stays FROZEN.** id `<WF01_ID>`. versionId at 7.3c
...
|---|---|---|---|---|---|
| 00 | `<WF00_ID>` | true | `<WF00_PUBLISHED>` | same | true |
| 00b | `<WF00B_ID>` | **false** | `<WF00B_SAVED>` | **null** | **false** (expected) |
| 01 | `<WF01_ID>` | true | `e3f817e2-9989-4486-8c7d-fe2ebb0d1b8a` | same | true |
| 02 | `<WF02_ID>` | true | `ddb4d858-b100-4a13-a567-b8528cb892c8` | same | true |
| 03 | `<WF03_ID>` | true | `<WF03_PUBLISHED>` | same | true |
| 04 | `<WF04_ID>` | true | `<WF04_PUBLISHED>` | same | true |
| 05 | `<WF05_ID>` | true | `181a4c32-1406-440d-9f1c-b927d6cf80b1` | same | true |
| 06 | `<WF06_ID>` | **true** | `<WF06_ROLLBACK>` | same | true |
| 07 | `<WF07_ID>` | true | `<WF07_PUBLISHED_9_14>` | same | true |
| 08 | `<WF08_ID>` | true | `<WF08_PUBLISHED>` | same | true |
| 09 | `<WF09_ID>` | true | `4747cd4f-ea03-451b-bf76-f09e5a6544db` | same | true |
| 10 | `<WF10_ID>` | **false** | `9e649170-d239-4b96-8988-33d78f8f2d5f` | **null** | **false** (expected) |
...
| name | id |
|---|---|
| LNI-TEST-WF10-prove | `<TEST_WF10_PROVE_WF_ID>` |
| LNI-TEST-WF10-binmerge | `<TEST_WF10_BINMERGE_WF_ID>` |
| LNI-TEST-WF10-gmail-get | `<TEST_WF10_GMAIL_GET_WF_ID>` |
...
- **Supabase hardening.** Disable public signup, delete
  `<STRAY_AUTH_USER_ID>`, re-enable Confirm email. Owner.
...
- Signup / Confirm email / delete `<STRAY_AUTH_USER_ID>`.
