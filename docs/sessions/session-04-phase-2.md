...
model: `follow_ups[0].title` “Meeting with <CONTACT_7_NAME>” came from the
...
### OCR email-split — two <CONTACT_7_NAME> rows, now a visible suggestion
...
- E2E #61: 2 assets stored, four jobs succeeded, person
  **<CONTACT_19_NAME>** /
  **<CONTACT_19_NAME>**, company **BTGroup**, interaction summary
...
- Decide the pending `entity_candidates` row for the two <CONTACT_7_NAME>
