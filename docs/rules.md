...
| **S9** | Replay-minted person has no `interactions` row. Same guard as S6. #151 <CONTACT_36_NAME> `96066d72`. **Packet 13.2** (same PUT as S6). Do not UPDATE `person_id` by hand. |
