...
| 6 | Confirm whether anyone else needs access | Talal | **REOPENED Phase 12.** Q2 LOCKED: permanent test tenant (not throwaway). Schema 12.1. Live second `bot_state` **slipped** — packet **12.2b**. Never deleted. Plan: `docs/plans/phase-12-plan.md`. | 12.1 / 12.2 / 12.2b |
