...
| 10 | Post-event data repair, S1–S9, Apollo sweep, history outreach | **10.4b live.** 031 + WF-10 `source=history` `bdb37399` (rollback `1c1c39f4`). Composer v2 dry run only. Remaining 17 need authorisation. |
