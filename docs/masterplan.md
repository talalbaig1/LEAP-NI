...
| 10 | Post-event data repair, S1–S9, Apollo sweep, history outreach | **10.4b live.** 031 + WF-10 `source=history` `0799a8dd` (rollback `1c1c39f4`). Usable path proven. Remaining 17 need authorisation. |
