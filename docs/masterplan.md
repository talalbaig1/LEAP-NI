...
| 10 | Post-event data repair, S1–S9, Apollo sweep, history outreach | **10.4b live.** 031+032 + WF-10 `source=history` `bed27da5` (rollback `1c1c39f4`). Fourth dry run. Remaining 17 need authorisation. |
