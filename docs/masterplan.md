...
| 2 | Create new Supabase project, paid tier (~2 GB) | Talal | **DONE** — project `LEAP-NI`, `eu-central-1`, Pro, Postgres 17.6. Migrations `001`–`008` and `010` applied. `009` seed blocked until the owner Auth user exists. | — |
