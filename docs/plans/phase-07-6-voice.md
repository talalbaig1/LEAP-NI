...
`LNI-TEST-WF10-voice-exec` `<TEST_WF10_VOICE_WF_ID>` (now inactive)
...
| Fact | Value |
|---|---|
| WF-01 | `<WF01_ID>`, `active=true`, **was** `4d4d6e6c-…` (118). After 7.6 PUT: `864bcb8b-8ac1-4fb6-a577-8772ff5e22bd` (128). Rollback target `4d4d6e6c-40e1-49ad-80f6-5e67203ce0b3`. |
| WF-10 | `<WF10_ID>`, `active=true`, versionId `40c0d5d9-15b8-4ad9-8b60-ff93f88646d8` |
| WF-03 | `<WF03_ID>`, Whisper node `OpenAI transcribe` |
