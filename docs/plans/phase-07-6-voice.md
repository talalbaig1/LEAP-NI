...
| Fact | Value |
|---|---|
| WF-01 | `<WF01_ID>`, `active=true`, versionId **must be** `4d4d6e6c-40e1-49ad-80f6-5e67203ce0b3` (118 nodes, frozen). If it differs, **STOP**. |
| WF-10 | `<WF10_ID>`, `active=true`, versionId `8bd44005-8d91-422b-80f3-b0820b9e1e20` |
