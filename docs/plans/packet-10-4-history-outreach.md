...
- Wrong-script: Urdu for <CONTACT_40_NAME>, <CONTACT_41_NAME>
- Garbled entities: "AAA AAA" for TripLA, "sulphur"
- Factually wrong summary: <CONTACT_15_NAME> recorded as
  "software developer at NetEngine Bus"; he is at VirtueNetz

Do not write confidently from a bad transcript (D-F).

5 Sep counted 16 with email, 3 already emailed (<CONTACT_14_NAME>
Chauhan, <CONTACT_11_NAME>, <CONTACT_15_NAME>) → 13 remaining. 7 Sep
...
| Person | Channel | Ask |
|---|---|---|
| <CONTACT_12_NAME> (Antler) | LinkedIn only | SilaCares |
| <CONTACT_13_NAME> (Blossom) | WhatsApp only | SilaCares |
| <CONTACT_11_NAME> | (owner sends) | iOS/Android launch help |
| <CONTACT_6_NAME> | (owner sends) | iOS/Android launch help |
...
- One Gmail draft. To: `<CONTACT_3_EMAIL>` **and**
  `<CONTACT_4_EMAIL>`.
...
- Rollback WF-10 published **`<WF10_ROLLBACK_DESRAJ>`**
  ...
  **`0799a8dd-2e16-4cc8-b3c4-fb9dddfe7b34`** (172 nodes).
  Non-Latin script is not garbled. Extract proven on <CONTACT_3_NAME>
...
- `Route source` outputs: 0 command, 1 voice, 2 callback,
  3 history, 4 unknown.
- Kick path was `POST /webhook/<WF10_HISTORY_PATH>`
...
- Gmail draft + real attachment proven before the batch:
  `LNI-TEST- 10.4b gmail draft attach` `<TEST_104B_ATTACH_WF_ID>`
...
- First dry run **rejected**. Martin was a pre-event
  ...
  `created_at` / `LNI %` / example-email filter). <CONTACT_1_NAME>
...
|---|---|---|---|---|---|---|---|
| <CONTACT_41_NAME> | `e4f1751a` | **461817** | 925 | `0ee1d8f4` | `r-1419115434923293829` | 1 | wrong-script |
| <CONTACT_36_NAME> | `96066d72` | **461818** | 926 | `ab87acc9` | `r484651116714432984` | 0 | no transcript |
| <CONTACT_40_NAME> | `a864283f` | **461819** | 927 | `7dc52905` | `r-3776398866982478871` | 1 | wrong-script |
...
|---|---|---|---|---|---|---|---|
| <CONTACT_3_NAME> | `d2335783` | **461871** | 928 | `10787045` | `r6789855113287998840` | Extract | 110524 |
| <CONTACT_22_NAME> | `2ca63896` | **461872** | 929 | `c2c819f8` | `r-8320115643520228008` | Extract | 0 |
| <CONTACT_23_NAME> | `db31bc6e` | **461873** | 930 | `76083561` | `r-7517758840755362577` | template (`aaa aaa`) | 103619 |
...
- C5 / fourth dry run. Stale v2 + <CONTACT_3_NAME> v3 cancelled.
  Prompt `wf10-hist-v4`. Published **`<WF10_PUBLISHED_HIST_V4>`**.
  Owner reads bodies. STOP.

| Person | person_id | Exec | Telegram | follow_ups | Gmail draft | Path | Attach | Reason |
|---|---|---|---|---|---|---|---|---|
| <CONTACT_40_NAME> | `a864283f` | **462396** | 931 | `32146c79` | `r-2339983374018899941` | Extract | 114326 | Urdu usable |
| <CONTACT_41_NAME> | `e4f1751a` | **462397** | 932 | `5f4d1173` | `r635050107219057841` | Extract | 111968 | Urdu usable |
| <CONTACT_36_NAME> | `96066d72` | **462398** | 933 | `a8b2dbaf` | `r7147000344519431064` | template | 107532 | no transcript |
| <CONTACT_3_NAME> | `d2335783` | **462399** | 934 | `b1786e3f` | `r-4333065214953054450` | Extract | 110524 | greeting + HTML sig |
...
- Deema + Abdalla regenerated v4. Remaining in-window
  ...
  person per webhook. WF-10 still `<WF10_PUBLISHED_HIST_V4>`.
  WhatsApp / LinkedIn not started.

| Person | person_id | Exec | Telegram | follow_ups | Gmail draft | Path | Attach | Reason |
|---|---|---|---|---|---|---|---|---|
| <CONTACT_22_NAME> | `2ca63896` | **462459** | 935 | `c789f86c` | `r8067515570626867707` | Extract | 0 | usable |
| <CONTACT_23_NAME> | `db31bc6e` | **462469** | 936 | `1fbc8a9f` | `r8677868495208793358` | template | 103619 | aaa aaa |
| <CONTACT_10_NAME> | `deafcf1a` | **462472** | 937 | `a9ac18b1` | `r7748022095252994021` | Extract | 0 | usable |
| <CONTACT_16_NAME> | `32c8efee` | **462474** | 938 | `a1b91e19` | `r-836529973338330291` | template | 0 | no transcript |
| <CONTACT_24_NAME> | `9bfa8ce0` | **462475** | 939 | `724f0add` | `r5119167887856017740` | template | 0 | no transcript |
| <CONTACT_25_NAME> | `1831ecd0` | **462476** | 940 | `9309173a` | `r5415257922690620755` | Extract | 0 | usable |
| <CONTACT_26_NAME> | `a602827b` | **462477** | 941 | `83b68f68` | `r-1790470466397325196` | template | 106306 | no transcript |
| <CONTACT_27_NAME> | `26ed5169` | **462478** | 942 | `44c889ca` | `r434767192073961307` | Extract | 0 | usable |
| <CONTACT_28_NAME> | `681d308c` | **462479** | 943 | `adff2e7c` | `r3542818162193356830` | template | 0 | no transcript |
| <CONTACT_29_NAME> | `b01f265a` | **462481** | 944 | `d4b7074e` | `r1626157842668145537` | template | 0 | no transcript |
| <CONTACT_30_NAME> | `32bac9fc` | **462482** | 945 | `988d4cd2` | `r-6183830881006665318` | template | 0 | no transcript |
| <CONTACT_1_NAME> | `9f91fb97` | **462483** | 946 | `c208f7b6` | `r1436963579507133188` | template | 106701 | no transcript |
| <CONTACT_31_NAME> | `40b9bbe4` | **462485** | 947 | `6a7cf7b9` | `r5109628820246424018` | template | 125373 | garbled |
| <CONTACT_32_NAME> | `77efedfd` | **462487** | 948 | `245ed4cb` | `r1790556644158495512` | template | 0 | no transcript |
| <CONTACT_33_NAME> | `541a55ec` | **462488** | 949 | `b2809899` | `r8981891638223927533` | template | 0 | no transcript |

  Skipped by load filter / human dedupe: D-H four,
  <CONTACT_14_NAME>, <CONTACT_15_NAME>, `<CONTACT_1_DOMAIN>` typo, <CONTACT_3_NAME> <CONTACT_2_COMPANY>
  row (same human as live <CONTACT_4_COMPANY> draft), pre-window,
  LNI-prefix, example/invalid. 19 humans, not 23 rows.

- <CONTACT_14_NAME> second-touch email. Sent row `4c58b08a` untouched
  ...
  photo 83829. WF-10 **`<WF10_PUBLISHED_DESRAJ>`** (rollback `<WF10_ROLLBACK_DESRAJ>`).
...
|---|---|---|---|---|---|---|
| <CONTACT_34_NAME> | whatsapp | **462602** | 951 | `66b1d4a7` | Extract | 172 |
| <CONTACT_16_NAME> | whatsapp | **462603** | 952 | `c9fcd3c7` | template | 150 |
| <CONTACT_35_NAME> | linkedin | **462604** | 953 | `f3962905` | template | 126 |

Those three dry-run rows were **cancelled** before CH2–CH5
regeneration (<CONTACT_16_NAME> WhatsApp had wrongly `second_touch=true`
...
touch, same as <CONTACT_14_NAME>. <CONTACT_15_NAME> and <CONTACT_6_NAME>
(09-07 row `58ea7ec0`, the one with email + phone) are
on the History load. <CONTACT_15_NAME>'s transcript is factually
wrong ("NetEngine Bus"; he is at VirtueNetz) — name
force to template, Extract never runs. <CONTACT_11_NAME>,
<CONTACT_12_NAME>, <CONTACT_13_NAME>, both <CONTACT_20_NAME> rows, and
<CONTACT_51_NAME> stay excluded.
...
only. A Gmail draft is not a touch. <CONTACT_16_NAME> WhatsApp
...
WF-10 published **`<WF10_PUBLISHED_CH5>`**. 42 kicks, all HTTP 200.
...
email draft: **<CONTACT_11_NAME>** only (manual). <CONTACT_3_NAME>
<CONTACT_2_COMPANY> row `ba037ac0` also has no draft — D-J duplicate
of the <CONTACT_4_COMPANY> row; both addresses already on that
Gmail To:.

**CH4 proof.** <CONTACT_16_NAME> WhatsApp `8138a531` Telegram
959, `second_touch=false` (email is `gmail_draft`, not
`sent`). <CONTACT_15_NAME> + <CONTACT_14_NAME> `second_touch=true`.

**CH2 proof.** Local SA → `966` and drop 0: <CONTACT_39_NAME>
`wa.me/966509609942`, <CONTACT_11_NAME> `966538584129`, Raheel
`966567888578`. <CONTACT_31_NAME>: no link, 996 flag, Telegram
...
|---|---|---|---|---|---|---|---|---|
| <CONTACT_6_NAME> | email | template | no transcript | 1259 | n/a | n/a | c4f9a0aa…jpg | 955 |
| <CONTACT_15_NAME> | email | template | NetEngine Bus forced | 1164 | n/a | n/a | cdf49511…jpg | 954 |
| <CONTACT_23_NAME> | whatsapp | template | aaa aaa | 237 | https://wa.me/966562284579 | n/a | e26b572f…jpg | 956 |
| <CONTACT_36_NAME> | whatsapp | template | no transcript | 238 | https://wa.me/966547098160 | n/a | 6ea2d374…jpg | 957 |
| <CONTACT_10_NAME> | whatsapp | Extract | usable | 333 | https://wa.me/966541105476 | n/a | - | 958 |
| <CONTACT_16_NAME> | whatsapp | template | no transcript | 235 | https://wa.me/966582887324 | n/a | - | 959 |
| <CONTACT_24_NAME> | whatsapp | template | no transcript | 237 | https://wa.me/918434348504 | n/a | - | 960 |
| <CONTACT_37_NAME> | whatsapp | template | no transcript | 235 | https://wa.me/447545222169 | n/a | - | 961 |
| <CONTACT_14_NAME> | whatsapp | template | no transcript | 250 | https://wa.me/966538714540 | n/a | efece2a9…jpg | 963 |
| <CONTACT_22_NAME> | whatsapp | Extract | usable | 363 | https://wa.me/966534037303 | n/a | - | 962 |
| <CONTACT_25_NAME> | whatsapp | Extract | usable | 328 | https://wa.me/21629350910 | n/a | - | 964 |
| <CONTACT_6_NAME> | whatsapp | template | no transcript | 235 | https://wa.me/966556677268 | n/a | c4f9a0aa…jpg | 965 |
| <CONTACT_38_NAME> | whatsapp | template | no transcript | 235 | https://wa.me/97336555758 | n/a | - | 966 |
| <CONTACT_26_NAME> | whatsapp | template | no transcript | 237 | https://wa.me/966543334381 | n/a | 697cf050…jpg | 967 |
| <CONTACT_27_NAME> | whatsapp | Extract | usable | 315 | https://wa.me/971525122455 | n/a | - | 968 |
| <CONTACT_28_NAME> | whatsapp | template | no transcript | 235 | https://wa.me/923335684410 | n/a | - | 969 |
| <CONTACT_29_NAME> | whatsapp | template | no transcript | 236 | https://wa.me/923324046546 | n/a | - | 970 |
| <CONTACT_39_NAME> | whatsapp | template | no transcript | 235 | https://wa.me/966509609942 | n/a | - | 971 |
| <CONTACT_30_NAME> | whatsapp | template | no transcript | 238 | https://wa.me/923167142536 | n/a | - | 972 |
| <CONTACT_3_NAME> | whatsapp | Extract | usable | 334 | https://wa.me/447522192620 | n/a | 96e2bf67…jpg | 973 |
| <CONTACT_40_NAME> | whatsapp | Extract | usable | 327 | https://wa.me/966582839355 | n/a | 4db135cb…jpg | 974 |
| <CONTACT_34_NAME> | whatsapp | Extract | usable | 343 | https://wa.me/966567888578 | n/a | 492ef0e6…jpg | 975 |
| <CONTACT_1_NAME> | whatsapp | template | no transcript | 236 | https://wa.me/923334002269 | n/a | 2b14354c…jpg | 976 |
| <CONTACT_15_NAME> | whatsapp | template | NetEngine Bus forced | 254 | https://wa.me/923028444707 | n/a | cdf49511…jpg | 977 |
| <CONTACT_32_NAME> | whatsapp | template | no transcript | 237 | https://wa.me/966591910548 | n/a | - | 978 |
| <CONTACT_41_NAME> | whatsapp | Extract | usable | 307 | https://wa.me/923012730261 | n/a | 80372849…jpg | 979 |
| <CONTACT_31_NAME> | whatsapp | template | garbled | 234 | no link: stored 996 is Kyrgyzstan, OCR, do not auto-correct | n/a | 6a4ecbf0…jpg | 980 |
| <CONTACT_33_NAME> | whatsapp | template | no transcript | 237 | https://wa.me/962788711503 | n/a | - | 981 |
| <CONTACT_11_NAME> | whatsapp | template | no transcript | 236 | https://wa.me/966538584129 | n/a | - | 982 |
| <CONTACT_42_NAME> | whatsapp | template | no transcript | 235 | https://wa.me/923000334560 | n/a | - | 983 |
| <CONTACT_43_NAME> | whatsapp | template | no transcript | 236 | https://wa.me/966554936765 | n/a | - | 984 |
| <CONTACT_44_NAME> | linkedin | Extract | usable | 247 | n/a | name search | 10fa70f3…jpg | 985 |
| <CONTACT_14_NAME> | linkedin | Extract | usable | 184 | n/a | name+Utopian | - | 986 |
| <CONTACT_45_NAME> | linkedin | Extract | usable | 222 | n/a | name search | - | 987 |
| <CONTACT_27_NAME> | linkedin | Extract | usable | 208 | n/a | name search | 8bd42dda…jpg | 988 |
| <CONTACT_46_NAME> | linkedin | template | no transcript | 139 | n/a | name+BYOC.global | - | 989 |
| <CONTACT_47_NAME> | linkedin | template | no transcript | 137 | n/a | name search | - | 990 |
| <CONTACT_48_NAME> | linkedin | Extract | usable | 233 | n/a | name+KFUPM | 858a7cef…jpg | 991 |
| <CONTACT_49_NAME> | linkedin | Extract | usable | 225 | n/a | name+BYOC.global | deff4730…jpg | 992 |
| <CONTACT_50_NAME> | linkedin | Extract | usable | 242 | n/a | name+Blinkco.io | - | 993 |
| <CONTACT_35_NAME> | linkedin | template | no transcript | 141 | n/a | name+MarsDevs | b77e443c…jpg | 994 |
| <CONTACT_44_NAME> | linkedin | template | no transcript | 136 | n/a | Arabic name+SEED | - | 995 |
