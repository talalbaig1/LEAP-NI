...
**Date:** 29 August 2026
**Status:** ACCEPTED. Packet 9.1 applies WF-02, WF-05, and migration
029. WF-01 is **not** applied until the owner reports the phone test
passed. Skip WF-04 (architect). Store raw `msg.contact` JSON and
verbatim vCard text. Receipt wording per §8. Followup-block contact
behaves like a photo.
...
Rollback: WF-01 `1d53c03d` (untouched this packet), WF-02
`071a4794`, WF-05 `181a4c32`, WF-10 `ab21c10c` (untouched).
