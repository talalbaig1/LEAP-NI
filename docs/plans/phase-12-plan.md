...
| **12.8** | SECOND TENANT. IRREVERSIBLE. The 12.2b door. | **041 applied** (`20260917060142`) | **No PUT.** B1/B2a/B2b/B7 verified. B3 `/digest` cause-only (not silent in n8n). STOP before B4/B5. Abort = delete tenant `bot_state`. |
