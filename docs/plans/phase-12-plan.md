...
| **12.8** | SECOND TENANT. IRREVERSIBLE. The 12.2b door. | **041 applied** (`20260917060142`) | **No PUT.** B1–B4 done. B4 N=2 scheduled briefing **495953**. STOP before B5. Abort = delete tenant `bot_state`. |
